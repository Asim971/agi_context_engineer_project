...
var Config = {
  ...
  // API Configuration
  MAYTAPI_API_KEY:
    PropertiesService.getScriptProperties().getProperty("MAYTAPI_API_KEY"),
  MAYTAPI_URL:
    "https://api.maytapi.com/api/55968f1b-01dc-4f02-baca-af83b92ca455/90126/sendMessage",
  ...
  FORMS: {
    ...
    DISPUTE: "YOUR_DISPUTE_FORM_ID_HERE", // IMPORTANT: Replace with a real form ID
  },
  ...
  HEADERS: {
    DEMARCATION: ["District", "Uujila", "Bazaar"],
    ...
    POTENTIAL_SITE: [
      ...
      "Project Address",
      "Site Image",
      "Start Storied Building",
      "End Storied Building",
      "AIL Territory",
      "ACL Territory",
      "Engineer Details",
      "Contractor Details",
    ...
    ENGINEER: [
      ...
      "Phone Number",
      "Email Address",
      "Address with Organization Name",
      "Designation of Organization",
      "District Name Of Working Area",
      "Thana Of Working Area",
      "Concerned BD Officer",
      "Select Education",
    ...
    ID_TRACKING: ["Form Type", "Prefix", "Last ID"],
    DISPUTES: [
      "Timestamp",
      "Dispute ID",
      "Type",
...
// This is required for ServiceBootstrap to access it
...
console.log("✅ Config registered globally");
